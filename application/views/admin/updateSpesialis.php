            ...
            <div class="col-md-4">
               <div class="card">
                  <div class="card-body">
                     ...
                     <form action="<?= base_url('admin/spesialis/updateSpesialis/' . $formData[0]->id) ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                           <label for="nama" class="col-form-label">nama</label>
                           <input class="form-control" id="nama" name="nama" value="<?= $formData[0]->nama ?>">
                        </div>
                        <div class="form-group">
                           <label for="judul" class="col-form-label">Icon</label>
                           <div class="custom-file">
                              <input type="file" class="custom-file-input" id="gambar" name="gambar" value="<?= $formData[0]->icon ?>">
                              <label class="custom-file-label" for="gambar">Pilih Icon</label>
                           </div>

                           <div class="image-preview" id="image-preview">
                              <img alt="image preview" class="image-preview-chosen" src="<?= base_url('assets/images/icon/icon-marker/' . $formData[0]->icon)  ?>">
                           ...
                           <tbody>
                              ...
                              foreach ($dataSpesialis as $spesialis) : ?>
                                 <tr>
                                    ...
                                    <td>
                                       <a type="button" id="update-btn" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" data-id="<?= $spesialis->id ?>" data-nama="<?= $spesialis->nama ?>" data-icon="<?= $spesialis->icon ?>"><i class="fa fa-pencil"></i></a>
