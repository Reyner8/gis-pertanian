...
function addMarker(props) {
	...
	// var iconSize = new google.maps.Size(60, 50);
   // marker.setIcon({
   //    size: iconSize,
   // });
...
function content(data) {
	return `<div class="card">
				<div class="card-body">
					...
					<a href="${baseUrl}dokter/detailDokter/${data.idDokter}">Detail</a>
				</div>
			  </div>`
}
...
async function calculateAndDisplayRoute(directionsService, directionsRenderer) {	
	...
	var icons = {
		start: new google.maps.MarkerImage(`${baseUrl}assets/images/icon/starting-marker.png`),	
		end: new google.maps.MarkerImage(`${baseUrl}assets/images/icon/icon-marker/${iconDestination}`)
	};	
